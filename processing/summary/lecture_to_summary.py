...
def _run_pdflatex(out_dir: Path, temp_latex: Path, executable: str = "pdflatex") -> None:
    command = [
        executable,
        "-halt-on-error",
...
def render_latex(latex: str, pdflatex_executable: str = PDFLATEX_EXECUTABLE) -> bytes:
    ...
    with tempfile.TemporaryDirectory() as _tmpdir:
        ...
        with temp_latex.open("w", encoding="utf-8") as f:
            f.write(latex)
        ...
        _run_pdflatex(out_dir, temp_latex, pdflatex_executable)
