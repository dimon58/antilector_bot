...
def upgrade() -> None:
    ...
    op.create_table('telegramchatfullinfo',
    ...
    sa.Column('business_location', ImmutablePydanticField(aiogram.types.business_location.BusinessLocation), nullable=True),
    sa.Column('business_opening_hours', ImmutablePydanticField(aiogram.types.business_opening_hours.BusinessOpeningHours), nullable=True),
    sa.Column('personal_chat', ImmutablePydanticField(aiogram.types.chat.Chat), nullable=True),
    sa.Column('available_reactions', sa.ARRAY(ImmutablePydanticField(aiogram.types.reaction_type.ReactionType)), nullable=True),
