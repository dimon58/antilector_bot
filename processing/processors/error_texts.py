...
def get_generic_error_text(processed_video: ProcessedVideo) -> str:
    return f"Ошибка обработки видео {yt_dlp_get_html_link(processed_video.original_video.yt_dlp_info)}"


def get_unable_to_process_text(processed_video: ProcessedVideo) -> str:
    return (
...
def get_silence_only_error_text(processed_video: ProcessedVideo) -> str:
    return (
